...
INSERT INTO Rules (ruleS, id_majors, description) VALUES (N'S1 ∧ S5 ∧ ¬S13 → P1', 'P1', N'Nếu sinh viên yêu thích lập trình phần mềm, thích làm việc với dữ liệu lớn và không quan tâm đến nghiên cứu bảo mật, thì họ chọn chuyên ngành Công nghệ phần mềm.');
